...
public class vocabulary extends Lexer {
    ...
    public static final int
            ...
            MODULE=44, INPUT=45, OUTPUT=46, FOR=47, CLASS=48, CONSTRUCTOR=49, DESTRUCTOR=50,
            BREAK=51, CONTINUE=52, SWITCH=53, CASE=54, PROTECTED=55, PRIVATE=56, PUBLIC=57,
            THIS=58, RETURN=59, TRY=60, CATCH=61, FINALLY=62, THROW=63, NEW=64, DELETE=65,
            INCLUDE=66, USING=67, NAMESPACE=68, IMPORT=69, EXTENDS=70, INTERFACE=71,
            ENUM=72, STATIC=73, ABSTRACT=74, FINAL=75, CONST=76, DO=77, DEFAULT=78,
            IMPLEMENTS=79, SUPER=80, THROWS=81, VOID=82, IDENTIFIER=83;
